...
const ProviderButton = ({
  ...
  <button
    onClick={onClick}
    disabled={disabled}
    className={`w-full flex items-center justify-center gap-3 font-semibold py-3.5 px-6 rounded-full transition-all duration-300 transform hover:scale-[1.02] shadow-md hover:shadow-lg ${bgClass} ${textClass} ${borderClass} ${disabled ? "opacity-50 cursor-not-allowed hover:scale-100" : "cursor-pointer"}`}
  >
    {icon}
    <span>Вход с {name}</span>
  </button>
);
...
const providers = [
  ...
  },
  {
    ...
    borderClass: "",
    enabled: false, // Enable when Facebook provider is configured
  },
  // Future providers:
  // {
  //   id: "instagram",
      ...
      <div className="relative z-10 max-w-md mx-auto px-4 py-16 w-full">
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-xl text-center">
          ...
          <p className="text-gray-600 mb-8">
            Влез в профила си, за да запазиш любимите си рецепти.
          </p>
